        ...
        if self.txt_fname.get()=="" or self.txt_contact.get()=="" or self.txt_email.get()=="" or \
            ...
            try:
                ...
                if row!=None:
                    ...
                    cur.execute("insert into regfields (f_name,l_name,contact,email,question,answer,password)"
                                " values(%s,%s,%s,%s,%s,%s,%s)",(self.txt_fname.get(),self.txt_lname.get(),
                                                                 self.txt_contact.get(),self.txt_email.get(),
                                                                 self.cmb_quest.get(),self.txt_answer.get(),
                                                                 self.txt_passwd.get()))
                    con.commit()
                    con.close()
